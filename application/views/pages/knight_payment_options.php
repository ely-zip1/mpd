          ...
          <div class="card">
            ...
            <div class="card-body">
              <ul class="nav nav-tabs" id="myTab" role="tablist">
                ...
                <li class="nav-item">
                  <a class="nav-link" id="bch-tab" data-toggle="tab" href="#bch" role="tab" aria-controls="bch"
                    aria-selected="false">Bitcoin Cash</a>
                </li>
                <li class="nav-item">
              ...
              <div class="tab-content" id="myTabContent">
                ...
                <div class="tab-pane fade show active" id="btc" role="tabpanel" aria-labelledby="btc-tab">
                  ...
                  <div class="form-group col-md-8">
                    <label for="btc-amount">Amount ($60 - $599)</label>
                ...
                <div class="tab-pane fade" id="eth" role="tabpanel" aria-labelledby="eth-tab">
                  ...
                  <div class="form-group col-md-8">
                    <label for="eth-amount">Amount ($60 - $599)</label>
                ...
                <div class="tab-pane fade" id="bch" role="tabpanel" aria-labelledby="bch-tab">
                  <?php echo form_open($form_submission,'name="bch-form"'); ?>
                  <div class="form-group col-md-8">
                    <label for="bch-address">Bitcoin Cash Address</label>
                    <input type="text" class="form-control" id="bch-address" readonly value="<?php if (isset($bch))
                              {
                                  echo $bch;
                              } ?>">
                  ...
                  <div class="form-group col-md-8">
                    <label for="bch-amount">Amount ($60 - $599)</label>
                    <input type="text" class="form-control <?php if (strlen(form_error('bch-amount')) > 0)
                              {
                                  echo "is-invalid";
                              } ?>" id="bch-amount" name="bch-amount" value="<?php if (isset($bch_value))
                              {
                                  set_value('bch-amount', $bch_value, true);
                              } ?>">
                    <div class="invalid-feedback">
                      <?php echo form_error('bch-amount'); ?>
                    </div>
                  </div>
                  <input type="hidden" name="pay-type" value="bch" />
                  <div class="form-group col-md-8">
                    <button type="submit" class="btn btn-warning btn-sm" name="bch-submit">
                      Submit
                    </button>
                  </div>
                  </form>
                ...
                <div class="tab-pane fade" id="gc" role="tabpanel" aria-labelledby="gc-tab">
                  ...
                  <div class="form-group col-md-8">
                    <label for="gc-amount">Amount ($60 - $599)</label>
                ...
                <div class="tab-pane fade" id="pp" role="tabpanel" aria-labelledby="pp-tab">
                  ...
                  <div class="form-group col-md-8">
                    <label for="pp-amount">Amount ($60 - $599)</label>
